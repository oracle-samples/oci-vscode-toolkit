 ...
 */
 ...
 export class CompartmentsNode extends RootNode {
     constructor() {
         super(
             'orm-compartmentsNode',
             CompartmentsItem.label,
             vscode.TreeItemCollapsibleState.Collapsed,
             getResourcePath(path.join('light','compartment-node-light')),
             getResourcePath(path.join('dark','compartment-node-dark.svg')),
