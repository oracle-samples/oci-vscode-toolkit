...
export function Download(webview: Webview, extensionUri: Uri, header: string, content: any, fileName: string) {
   ...
   return /*html*/ `
    ...
    <head>
       ...
       <script id="script_content_decode_js" type="module" src="${decodeScriptContent}">${content}</script>
    ...
    <body id="webview-body">
      <h1>${header}</h1>
       ...
       <input type="hidden" id="download-content" value="${JSON.stringify(content, null, 2)}"/>
    </body>
    </html>
    `;
}
